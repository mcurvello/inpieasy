...
<body>
    <div id="page-landing">
        <div id="container">
            ...
            <section id="defiance">
                <div>
                    <h1><?= strtoupper($logado)?>, que bom que pôde seguir com seu registro.</h1>
                    <p>  
                        Agora você deve gerar a guia de pagamento referente ao seu pedido. Pague seu GRU e retorne na plataforma para confirmar pagamento e ir para a próxima etapa.
                    </p>
                </div>
                <div id="choices">
                    <div>
                        <button> <a href="">Gerar Boleto GRU</a> </button>
                    </div>
                    <div>
                        <h5>Após o pagamento, digite o número da sua GRU</h5>
                        <input type="text" placeholder="Número GRU">
                    </div>
                </div>
            </section>
            <footer id="footer">
                ...
                <div>
                    ...
                    <button id="button-next"><a href="defiance7.php"> Avançar </a></button>
