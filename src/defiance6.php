...
<body>
    <div id="page-landing">
        <div id="container">
            ...
            <section id="defiance">
                <div>
                    <h1>%username%, você completou a primeira fase, estamos quase lá!</h1>
                    <p>Agora que você já possui um logotipo e sabemos o tipo da sua marca, vamos saber mais detalhes sobre ela.</p>
                </div>
                <div id="box">
                    <h5>Apresentação da Marca</h5>
                    ...
                    <h5>Número da Classe NCL</h5>
                    <input type="text" placeholder="Número da Classe NCL">
